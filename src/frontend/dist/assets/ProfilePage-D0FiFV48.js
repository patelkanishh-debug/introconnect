import { j as jsxRuntimeExports, o as cn, r as reactExports, p as createSlot, q as o, v as vt, u as useCurrentUser, b as useBackend, a as useNavigate, i as useQueryClient, L as Layout, I as Interest, B as Button } from "./index-DSt5PXRa.js";
...
function ProfilePage() {
  ...
  const isSetup = !(profile == null ? void 0 : profile.displayName);
  ...
  const toggleInterest = (interest) => {
    setSelected(
      (prev) => prev.includes(interest) ? prev.filter((i) => i !== interest) : prev.length < 3 ? [...prev, interest] : prev
    );
  };
  const validate = () => {
  ...
  if (authLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground animate-pulse", children: "Loading…" }) }) });
  }
  if (!isAuthenticated) {
    navigate({ to: "/welcome" });
    return null;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { hideNav: isSetup, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center px-6 py-10 max-w-md mx-auto w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: isSetup ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "👋" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground mb-1", children: "Set up your profile" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Just your first name — no email, no personal info needed." })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/15 flex items-center justify-center text-2xl mx-auto mb-3", children: displayName ? displayName[0].toUpperCase() : "?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground", children: "Edit Profile" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          nameError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm text-destructive", children: nameError })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "Your interests" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              selected.length,
              "/3 selected"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: ALL_INTERESTS.map((item, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.button,
              {
                ...
                className: [
                  ...
                  isSelected ? "bg-primary/10 border-primary text-primary" : isDisabled ? "opacity-40 cursor-not-allowed bg-muted/40 border-border text-muted-foreground" : "bg-card border-border text-foreground hover:bg-muted/50"
                ].join(" "),
          ...
          selected.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "Pick up to 3 — we'll find people who share them." })
        ]
      }
    ),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              size: "lg",
              children: saving ? "Saving…" : isSetup ? "Start connecting ✨" : "Save changes"
            }
          ),
